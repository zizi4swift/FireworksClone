//
//  ClassicFireworkDemoViewController.swift
//  Firework
//
...
class ClassicFireworkDemoViewController: UIViewController {
    ...
    private var correctSoultionIndex: Int = 0
    ...
    private func refresh() {
        ...
        self.correctSoultionIndex = shuffled.firstIndex(of: sol1)!
    }
    
    @IBAction private func btnTapped(sender: UIButton) {
        self.checkSolution(selection: sender.tag, correct: self.correctSoultionIndex, button: sender)
